import urolog from "./images/urolog.jpg"
...
export default function Urologist() {
  return (
   ...
   Practitionals</h2>
    ...
    <p className="logist"><Link style={{color: '#1295F3', textDecoration: 'none' }} to="/Urologist">UROLOGIST</Link></p>
    </div>
    <div className="img-dept">
...
< div className="urologist">
<img className="neorologist" src={urolog} alt=""/>
<div className="neuro-main">
<h2 className="neuro-heading">UROLOGIST</h2>
<p className="neuro-text">
A urologist is a medical doctor specializing in 
conditions that affect the urinary tract in men,
 women and children, and diseases that affect the 
 reproductive system. These conditions range from
  peeing too much or too little to being unable to 
  father a child......<br/>
...
<button className="book-urologist"><Link style={{color: 'white', textDecoration: 'none' }} to="/Desktop9">Book Now</Link></button>
</div>
