...
export default function Cardiologist() {
  return (
   ...
   Practitionals</h2>
    ...
    <p><Link style={{color: '#1295F3', textDecoration: 'none' }} to="/Cardiologist"><img className="heart" src={heartt} alt="" /></Link></p>
    <p className="neuro"><Link style={{color: '#1295F3', textDecoration: 'none' }} to="/Cardiologist">CARDIOLOGIST</Link></p>
    </div>
...
<img className="neorologist" src={cardio} alt=""/>
<div className="neuro-main">
<h2 className="neuro-heading">CARDIOLOGIST</h2>
<p className="neuro-text">
Cardiologists are doctors who have extra education 
and training in preventing, diagnosing and treating 
heart conditions. They are experts on the heart muscle 
itself and the arteries and veins that carry blood....<br/>
...
<button className="book-cardiologist"><Link style={{color: 'white', textDecoration: 'none' }} to="/Desktop9">Book Now</Link></button>
</div>
