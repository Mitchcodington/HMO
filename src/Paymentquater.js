...
export default function Paymentquater() {
...
<div className="choice-period">
        ...
        <div className="pay-period">
            ...
            <span className="quater-payment"><Link  style={{color:'white' , textDecoration: 'none' }} to="/Paymentquater">Quaterly</Link></span>
            <span className="year"><Link  style={{color: '#04049D', textDecoration: 'none' }} to="/Paymentyear">Yearly</Link></span>
        </div>
</div>
...
<div className="choice-period">
            <p className="row3">Payment<br/><b>Unit Price:
                <span className="per-unit">49,050</span></b></p>
