import ophtalmo from "./images/ophtalmo.jpg"
...
export default function Ophthalmologist() {
  return (
   ...
   Practitionals</h2>
    ...
    <p className="logist"><Link style={{color: '#1295F3', textDecoration: 'none' }} to="/Ophthalmologist">OPHTHALMOLOGIST</Link></p>
    </div>
    <div className="img-dept">
    <p><img className="heart" src={nephro} alt="" /></p>
    <p className="logist"><Link style={{color: 'gray', textDecoration: 'none' }} to="/Nephrologist">NEPHROLOGIST</Link></p>
    </div>
...
<img className="neorologist" src={ophtalmo} alt=""/>
<div className="neuro-main">
<h2 className="neuro-heading">OPHTHALMOLOGIST</h2>
<p className="neuro-text">
An ophthalmologist is an eye care specialist. Unlike
optometrists and opticians, ophthalmologists are doctors
 of medicine or osteopathy with specific
  training and experience in diagnosing and treating eye and
  vision conditions......<br/>
...
<button className="book-opthal"><Link style={{color: 'white', textDecoration: 'none' }} to="/Desktop9">Book Now</Link></button>
</div>
