...
Healt h insurance for business convenience and proper 
management of your organization.</p>
...
<div className="everyone-learn">
    ...
    <p className="light-text"> Health  insurance for business convenience 
and proper management of your 
organization. </p>
<button className="business-btn"><Link to="/Employees">Learn More</Link></button>
</div>
</div>
