  ...
  return (
    <>
      ...
      <p className="everyone-text">
        Your employees will be happier and healthier on our health insurance
        plans
      </p>
      ...
      <div className="card-container">
        <div className="card-section">
          ...
          <div className="everyone-learn">
            ...
            <p className="light-text">
              Get a health cover that is designed to suit your specific needs
              and enjoy access to quality healthcare and superior service
              delivery for as low as ₦4,050 per month.{" "}
            </p>
            <button className="business-btn">
              <Link to="/empremium">Learn More</Link>
            </button>
          </div>
        </div>
        ...
        <div className="card-section">
          ...
          <div className="everyone-learn">
            ...
            <p className="light-text">
              {" "}
              An affordable health plan with access to quality healthcare for
              you and your loved ones for as low as ₦2,050 per month.{" "}
            </p>
        ...
        <div className="card-section">
          ...
          <div className="everyone-learn">
            ...
            <p className="light-text">
              An affordable health plan with access to quality healthcare for
              you and your loved ones for as low as ₦1,550 per month
            </p>
            <button className="business-btn">Learn More</button>
          </div>
        </div>
