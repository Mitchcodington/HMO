    ...
    <div className="footer-main">
      <footer>
        ...
        <div className="text-icon">
          <p className="footer-text">
            ...
            platea non sed enim. Faucibus orci tortor orci malesuada
          ...
          <p>
            <img className="call-icon" src={icon1} alt="" />
          </p>
        </div>
      ...
      <footer>
        ...
        <div className="text-icon">
          ...
          <p>
            <img className="call-icon" src={awareness} alt="" />
          </p>
        </div>
        <button className="learn-more">Learn more</button>
      </footer>
      ...
      <footer>
        ...
        <div className="text-icon">
          ...
          <p>
            <img className="call-icon" src={insurance} alt="" />
          </p>
        </div>
        <button className="learn-more">Learn more</button>
      </footer>
