...
<p className="footer-text">With LabOne,you don’t have to drive to the doctor’s
 ...
 are sick. You can see your doctor from the comfort of your own bed or sofa. </p>
...
<p><img className="dark-logo" src={darkfootlogo} alt="" /></p>
<div>
...
<p><img className="facebook" src={facebuk} alt="" /></p>
<p><img className="twitter" src={twitter} alt="" /></p>
<p><img className="instagram" src={instagram} alt="" /></p>
   </div>
