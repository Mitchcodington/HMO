...
lectus magna ipsum ac ultrices aliquam donec.</span></div>
  ...
  <legend>Name</legend> 
  <div className="input">
   <input placeholder="Enter Name"/><span  class="material-symbols-outlined">
account_circle
</span>
 </div> 
</fieldset>
...
<fieldset className="fieldset">
  ...
  <div className="input">
   <input placeholder="Name@gmail.com"/><span class="material-symbols-outlined">
mail
</span>
 </div> 
</fieldset>
...
<fieldset>
  ...
  <div className="input">
   <input placeholder="6+characters,1 capital letter"/><span class="material-symbols-outlined">
visibility_off
</span>
 </div> 
</fieldset>
<div className="input-terms">
  ...
  <p className="terms">Accept <a className="anchr-terms" href="img.com">Terms and Conditions</a></p>
  </div>
  <button className="signup-btn">Sign up</button>
  <p className="already">Already have an account? 
  <a className="anchr-signin" href="signin.html"><em><b>Sign in</b></em></a></p>
  <div class="header__center"><span className="signinwith"><b>Sign in with</b></span></div>
