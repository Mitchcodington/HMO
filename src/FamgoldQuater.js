...
export default function FamgoldQuater() {
    return (
        <>
       ...
       <p className="get-any-text">Get any comfortable payment plan. you can get as many plans 
        as you desire which is affordable.with time the plan would be
         ...
         <div className="period">
            <span className="monthly"><Link  style={{color: '#04049D', textDecoration: 'none' }} to="/GoldPlan">Monthly</Link></span>
            <span className="quaterly"><Link  style={{color: 'white', textDecoration: 'none' }} to="/FamgoldQuater">Quaterly</Link></span>
            <span className="year"><Link  style={{color: '#04049D', textDecoration: 'none' }} to="/FamgoldYearly">Yearly</Link></span>
        </div>
        
        <div className="card-main">
         <div className="amount-card">
            <h6 className="card-h6">For You And Your Family</h6>
            <p className="amount-payment"><span className="naira"> ₦ 63,050</span>
         ...
         <div className="amount-card">
            ...
            <p className="amount-payment"><span className="naira"> ₦ 67,500</span>
            <span className="family-payment">Family Payment<br/>
            Per Month</span></p>
            <button className="card-get-btn">Get</button>
            <p className="tiny-text">Medical checkout recommendation of drug: <span className="million">N1.7million</span> per year</p>
