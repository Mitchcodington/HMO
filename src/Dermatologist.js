import dermato from "./images/dermato.jpg"
...
export default function Dermatologist() {
  return (
   ...
   Practitionals</h2>
    ...
    <p className="logist"><Link style={{color: '#1295F3', textDecoration: 'none' }} to="/Dermatologist">DERMATOLOGIST</Link></p>
    </div>
    <div className="img-dept">
...
<img className="neorologist" src={dermato} alt=""/>
<div className="neuro-main">
<h2 className="neuro-heading">Dermatologist</h2>
<p className="neuro-text">
A dermatologist is a medical doctor who specializes in 
conditions that affect the skin, hair, and nails. Whether 
it's rashes, wrinkles, psoriasis, or melanoma, no one understands
your skin, hair, and nails better than a board-certified dermatologist.....<br/>
...
<button className="book-dermatologist"><Link style={{color: 'white', textDecoration: 'none' }} to="/Desktop9">Book Now</Link></button>
</div>
