...
export default function FambronzeQuater() {
    return (
        <>
       ...
       <p className="get-any-text">Get any comfortable payment plan. you can get as many plans 
        as you desire which is affordable.with time the plan would be
         ...
         <div className="period">
            <span className="monthly"><Link  style={{color: '#04049D', textDecoration: 'none' }} to="/Bronzeplan">Monthly</Link></span>
            <span className="quaterly"><Link  style={{color: 'white', textDecoration: 'none' }} to="/FambronzeQuater">Quaterly</Link></span>
