...
export default function GoldPlan() {
 ...
 <>
      ...
      <div className="period">
                 <span className="month-gold"><Link  style={{color: 'white', textDecoration: 'none' }} to="/GoldPlan">Monthly</Link></span>
                 <span className="quater"><Link  style={{color: '#04049D', textDecoration: 'none' }} to="/FamgoldQuater">Quaterly</Link></span>
        ...
        <div className="card-main">
          <div className="amount-card">
              <h6 className="card-h6">For You And Your Family</h6>
               <p className="amount-payment"><span className="naira"> ₦ 2,050</span></p>
         ...
         <div className="amount-card">
              ...
              <p className="amount-payment"><span className="naira"> ₦ 5,500</span></p>
