...
export default function FambronzeYearly() {
    return (
        <>
       ...
       <p className="get-any-text">Get any comfortable payment plan. you can get as many plans 
        as you desire which is affordable.with time the plan would be
         ...
         <div className="period">
            <span className="monthly-year"><Link  style={{color: '#04049D', textDecoration: 'none' }} to="/Bronzeplan">Monthly</Link></span>
            <span className="quaterly-year"><Link  style={{color: '#04049D', textDecoration: 'none' }} to="/FambronzeQuater">Quaterly</Link></span>
            <span className="yearly-year"><Link  style={{color: 'white', textDecoration: 'none' }} to="/FambronzeYearly">Yearly</Link></span>
        </div>
        
        <div className="card-main">
         <div className="amount-card">
            <h6 className="card-h6">For You And Your Family</h6>
            <p className="amount-payment"><span className="naira"> ₦ 249,050</span>
         ...
         <div className="amount-card">
            ...
            <p className="amount-payment"><span className="naira"> ₦ 253,500</span>
            <span className="family-payment">Family Payment<br/>
            Per Month</span></p>
         ...
         <div className="amount-card">
            ...
            <p className="amount-payment"><span className="naira"> ₦ 249,550</span>
            <span className="family-payment">Family Payment<br/>
            Per Month</span></p>
